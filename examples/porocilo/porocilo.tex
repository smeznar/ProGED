...
\FPclip\order\order  % Clipping zeros 00090000 away -> 9 
...
% p == \round{\coefA}
% p == \round[4]{\coefA}
% order = \( \FPclip{\o}{\order} \o \)
% order2 = \( \FPeval{\origam}{round( 1.345 * 1, 2)} \origam a dsa \)
% dsa2 = \( \FPeval{\o}{((-09) * (-1))*(-1)} \FPclip\o\o  \order -> \o \)
% % order2 = \( \FPeval{\or}{\order * 1} \or \)
% p third = \round{\coefA} \( \cdot 10^{\order}\)
% \\
