...
def eq_disco_demo (data, features_on_left: list = [1],
...
# print(eq_disco_demo(data, features_on_left=[2], features_on_right=[1,3]))
# print(eq_disco_demo(data, features_on_left=[3], features_on_right=[1,2]))
print(eq_disco_demo(data, features_on_left=[1], features_on_right=[2,3]))
