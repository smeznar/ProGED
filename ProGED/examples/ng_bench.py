...
if __name__ == '__main__':
    ...
    train = read_eq_data(args.eq_num)
    ...
    if args.baseline == "ProGED":
        ...
        with open(f"results/hvae_evo/nguyen_{args.eq_num}_{time.time()}.json", "w") as file:
...
# ---------------------------------------------------------------------------------------------------------------------
# For reproducible results from the "Hierarchical Variational Autoencoder for Arithmetic Expressions" generate runs using
#     for i in range(10):
#         for j in range(1, 9):
#             print(f"python ng_bench.py -eq_num {j} -baseline HVAE_evo -params /home/sebastianmeznar/Projects/ProGED/ProGED/examples/parameters/nguyen1_32.pt -dimension 32 -seed {i+18}")
#         for j in range(9, 11):
#             print(f"python ng_bench.py -eq_num {j} -baseline HVAE_evo -params /home/sebastianmeznar/Projects/ProGED/ProGED/examples/parameters/nguyen2_32.pt -dimension 32 -seed {i+18}")
# ---------------------------------------------------------------------------------------------------------------------
