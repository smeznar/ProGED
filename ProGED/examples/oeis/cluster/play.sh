...
singularity exec ~/pyProGED.simg python -m pytest ../../../tests/test_core.py
...
# singularity exec pyProGED.simg python fibonacci_oneby1.py  # online
singularity exec ~/pyProGED.simg python fibonacci_oneby1.py  # offline
